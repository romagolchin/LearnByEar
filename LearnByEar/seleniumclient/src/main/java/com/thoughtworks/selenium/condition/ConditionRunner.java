...
public interface ConditionRunner {
   ...
   * {@link Condition#isTrue(Context)} method, until:
   * <p/>
   * <ul>
  ...
  public interface Context {
     ...
     * called by any {@link Condition#isTrue(Context)}.
     */
    Selenium getSelenium();

    /**
     * A {@link Condition#isTrue(Context)} can call this method to set extra
